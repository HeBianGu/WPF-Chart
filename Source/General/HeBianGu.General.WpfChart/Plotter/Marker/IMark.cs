...
namespace HeBianGu.WPF.EChart
{
    ...
    public class ShapePointMarker : Shape
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            //     FlowDirection.LeftToRight, new Typeface("Arial"), FontZize, FontColor);

            //double width = textToDraw.Width;
            //double height = textToDraw.Height;
            //double verticalShift = -this.Size / 2; // px
            ...
            ////drawingContext.DrawLine(new Pen(Brushes.Black, 1), Point.Add(ScreenPoint, new Vector(0, verticalShift)), ScreenPoint);
            ////drawingContext.DrawRectangle(Brushes.White, new Pen(Brushes.Black, 1), bounds);
            //drawingContext.DrawText(textToDraw, loc);
        ...
        /// <summary> 复制 </summary>
        public virtual void CloneTo(ShapePointMarker mark)
        {
            mark.Fill = this.Fill;
            mark.FontColor = this.FontColor;
            mark.FontZize = this.FontZize;
            mark.Pen = this.Pen;
            mark.Text = this.Text;
            mark.ScreenPoint = this.ScreenPoint;
        }

        /// <summary> 复制 </summary>
        public virtual ShapePointMarker Clone()
        {
            ShapePointMarker mark = Activator.CreateInstance(this.GetType()) as ShapePointMarker;
